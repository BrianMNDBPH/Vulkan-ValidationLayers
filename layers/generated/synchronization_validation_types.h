...
enum SyncStageAccessIndex {
    SYNC_TOP_OF_PIPE_MEMORY_READ = 0,
    SYNC_TOP_OF_PIPE_MEMORY_WRITE = 1,
    SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ = 2,
    SYNC_DRAW_INDIRECT_MEMORY_READ = 3,
    SYNC_DRAW_INDIRECT_MEMORY_WRITE = 4,
    SYNC_DRAW_INDIRECT_TRANSFORM_FEEDBACK_COUNTER_READ_EXT = 5,
    SYNC_VERTEX_INPUT_INDEX_READ = 6,
    SYNC_VERTEX_INPUT_MEMORY_READ = 7,
    SYNC_VERTEX_INPUT_MEMORY_WRITE = 8,
    SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ = 9,
    SYNC_VERTEX_SHADER_MEMORY_READ = 10,
    SYNC_VERTEX_SHADER_MEMORY_WRITE = 11,
    SYNC_VERTEX_SHADER_SHADER_READ = 12,
    SYNC_VERTEX_SHADER_SHADER_WRITE = 13,
    SYNC_VERTEX_SHADER_UNIFORM_READ = 14,
    SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ = 15,
    SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE = 16,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_READ = 17,
    SYNC_TESSELLATION_CONTROL_SHADER_SHADER_WRITE = 18,
    SYNC_TESSELLATION_CONTROL_SHADER_UNIFORM_READ = 19,
    SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ = 20,
    SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE = 21,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_READ = 22,
    SYNC_TESSELLATION_EVALUATION_SHADER_SHADER_WRITE = 23,
    SYNC_TESSELLATION_EVALUATION_SHADER_UNIFORM_READ = 24,
    SYNC_GEOMETRY_SHADER_MEMORY_READ = 25,
    SYNC_GEOMETRY_SHADER_MEMORY_WRITE = 26,
    SYNC_GEOMETRY_SHADER_SHADER_READ = 27,
    SYNC_GEOMETRY_SHADER_SHADER_WRITE = 28,
    SYNC_GEOMETRY_SHADER_UNIFORM_READ = 29,
    SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ = 30,
    SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE = 31,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_COUNTER_WRITE_EXT = 32,
    SYNC_TRANSFORM_FEEDBACK_EXT_TRANSFORM_FEEDBACK_WRITE_EXT = 33,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT = 34,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ = 35,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE = 36,
    SYNC_TASK_SHADER_NV_MEMORY_READ = 37,
    SYNC_TASK_SHADER_NV_MEMORY_WRITE = 38,
    SYNC_TASK_SHADER_NV_SHADER_READ = 39,
    SYNC_TASK_SHADER_NV_SHADER_WRITE = 40,
    SYNC_TASK_SHADER_NV_UNIFORM_READ = 41,
    SYNC_MESH_SHADER_NV_MEMORY_READ = 42,
    SYNC_MESH_SHADER_NV_MEMORY_WRITE = 43,
    SYNC_MESH_SHADER_NV_SHADER_READ = 44,
    SYNC_MESH_SHADER_NV_SHADER_WRITE = 45,
    SYNC_MESH_SHADER_NV_UNIFORM_READ = 46,
    SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ = 47,
    SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE = 48,
    SYNC_SHADING_RATE_IMAGE_NV_SHADING_RATE_IMAGE_READ_NV = 49,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 50,
    SYNC_EARLY_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 51,
    SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ = 52,
    SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE = 53,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ = 54,
    SYNC_FRAGMENT_SHADER_MEMORY_READ = 55,
    SYNC_FRAGMENT_SHADER_MEMORY_WRITE = 56,
    SYNC_FRAGMENT_SHADER_SHADER_READ = 57,
    SYNC_FRAGMENT_SHADER_SHADER_WRITE = 58,
    SYNC_FRAGMENT_SHADER_UNIFORM_READ = 59,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_READ = 60,
    SYNC_LATE_FRAGMENT_TESTS_DEPTH_STENCIL_ATTACHMENT_WRITE = 61,
    SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ = 62,
    SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE = 63,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ = 64,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_READ_NONCOHERENT_EXT = 65,
    SYNC_COLOR_ATTACHMENT_OUTPUT_COLOR_ATTACHMENT_WRITE = 66,
    SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ = 67,
    SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE = 68,
    SYNC_COMPUTE_SHADER_MEMORY_READ = 69,
    SYNC_COMPUTE_SHADER_MEMORY_WRITE = 70,
    SYNC_COMPUTE_SHADER_SHADER_READ = 71,
    SYNC_COMPUTE_SHADER_SHADER_WRITE = 72,
    SYNC_COMPUTE_SHADER_UNIFORM_READ = 73,
    SYNC_TRANSFER_MEMORY_READ = 74,
    SYNC_TRANSFER_MEMORY_WRITE = 75,
    SYNC_TRANSFER_TRANSFER_READ = 76,
    SYNC_TRANSFER_TRANSFER_WRITE = 77,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_READ_NV = 78,
    SYNC_COMMAND_PREPROCESS_NV_COMMAND_PREPROCESS_WRITE_NV = 79,
    SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ = 80,
    SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE = 81,
    SYNC_CONDITIONAL_RENDERING_EXT_CONDITIONAL_RENDERING_READ_EXT = 82,
    SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ = 83,
    SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE = 84,
    SYNC_RAY_TRACING_SHADER_KHR_ACCELERATION_STRUCTURE_READ_KHR = 85,
    SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ = 86,
    SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE = 87,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_READ = 88,
    SYNC_RAY_TRACING_SHADER_KHR_SHADER_WRITE = 89,
    SYNC_RAY_TRACING_SHADER_KHR_UNIFORM_READ = 90,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_ACCELERATION_STRUCTURE_READ_KHR = 91,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_ACCELERATION_STRUCTURE_WRITE_KHR = 92,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ = 93,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE = 94,
    SYNC_BOTTOM_OF_PIPE_MEMORY_READ = 95,
    SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE = 96,
    SYNC_HOST_HOST_READ = 97,
    SYNC_HOST_HOST_WRITE = 98,
    SYNC_HOST_MEMORY_READ = 99,
    SYNC_HOST_MEMORY_WRITE = 100,
    SYNC_IMAGE_LAYOUT_TRANSITION = 101,
    SYNC_QUEUE_FAMILY_OWNERSHIP_TRANSFER = 102,
};

// Unique bit for each  stage/access combination
enum SyncStageAccessFlagBits : SyncStageAccessFlags {
    SYNC_TOP_OF_PIPE_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TOP_OF_PIPE_MEMORY_READ,
    SYNC_TOP_OF_PIPE_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TOP_OF_PIPE_MEMORY_WRITE,
    SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ_BIT = SyncStageAccessFlags(1) << SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ,
    SYNC_DRAW_INDIRECT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_DRAW_INDIRECT_MEMORY_READ,
    SYNC_DRAW_INDIRECT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_DRAW_INDIRECT_MEMORY_WRITE,
    ...
    SYNC_VERTEX_INPUT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_VERTEX_INPUT_MEMORY_READ,
    SYNC_VERTEX_INPUT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_VERTEX_INPUT_MEMORY_WRITE,
    SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ_BIT = SyncStageAccessFlags(1) << SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ,
    SYNC_VERTEX_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_VERTEX_SHADER_MEMORY_READ,
    SYNC_VERTEX_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_VERTEX_SHADER_MEMORY_WRITE,
    ...
    SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ,
    SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE,
    ...
    SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ,
    SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE,
    ...
    SYNC_GEOMETRY_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_GEOMETRY_SHADER_MEMORY_READ,
    SYNC_GEOMETRY_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_GEOMETRY_SHADER_MEMORY_WRITE,
    ...
    SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ,
    SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE,
    ...
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ,
    SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE,
    SYNC_TASK_SHADER_NV_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TASK_SHADER_NV_MEMORY_READ,
    SYNC_TASK_SHADER_NV_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TASK_SHADER_NV_MEMORY_WRITE,
    ...
    SYNC_MESH_SHADER_NV_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_MESH_SHADER_NV_MEMORY_READ,
    SYNC_MESH_SHADER_NV_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_MESH_SHADER_NV_MEMORY_WRITE,
    ...
    SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ,
    SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE,
    ...
    SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ,
    SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE,
    SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ_BIT = SyncStageAccessFlags(1) << SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ,
    SYNC_FRAGMENT_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_FRAGMENT_SHADER_MEMORY_READ,
    SYNC_FRAGMENT_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_FRAGMENT_SHADER_MEMORY_WRITE,
    ...
    SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ,
    SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE,
    ...
    SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ,
    SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE,
    SYNC_COMPUTE_SHADER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_COMPUTE_SHADER_MEMORY_READ,
    SYNC_COMPUTE_SHADER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_COMPUTE_SHADER_MEMORY_WRITE,
    ...
    SYNC_TRANSFER_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_TRANSFER_MEMORY_READ,
    SYNC_TRANSFER_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_TRANSFER_MEMORY_WRITE,
    ...
    SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ,
    SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE,
    ...
    SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ,
    SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE,
    ...
    SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ,
    SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE,
    ...
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ,
    SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE,
    SYNC_BOTTOM_OF_PIPE_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_BOTTOM_OF_PIPE_MEMORY_READ,
    SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE,
    ...
    SYNC_HOST_MEMORY_READ_BIT = SyncStageAccessFlags(1) << SYNC_HOST_MEMORY_READ,
    SYNC_HOST_MEMORY_WRITE_BIT = SyncStageAccessFlags(1) << SYNC_HOST_MEMORY_WRITE,
...
static std::map<SyncStageAccessFlags, SyncStageAccessIndex> syncStageAccessIndexByStageAccessBit  = {
    { SYNC_TOP_OF_PIPE_MEMORY_READ_BIT, SYNC_TOP_OF_PIPE_MEMORY_READ },
    { SYNC_TOP_OF_PIPE_MEMORY_WRITE_BIT, SYNC_TOP_OF_PIPE_MEMORY_WRITE },
    { SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ_BIT, SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ },
    { SYNC_DRAW_INDIRECT_MEMORY_READ_BIT, SYNC_DRAW_INDIRECT_MEMORY_READ },
    { SYNC_DRAW_INDIRECT_MEMORY_WRITE_BIT, SYNC_DRAW_INDIRECT_MEMORY_WRITE },
    ...
    { SYNC_VERTEX_INPUT_MEMORY_READ_BIT, SYNC_VERTEX_INPUT_MEMORY_READ },
    { SYNC_VERTEX_INPUT_MEMORY_WRITE_BIT, SYNC_VERTEX_INPUT_MEMORY_WRITE },
    { SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ_BIT, SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ },
    { SYNC_VERTEX_SHADER_MEMORY_READ_BIT, SYNC_VERTEX_SHADER_MEMORY_READ },
    { SYNC_VERTEX_SHADER_MEMORY_WRITE_BIT, SYNC_VERTEX_SHADER_MEMORY_WRITE },
    ...
    { SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ_BIT, SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ },
    { SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE_BIT, SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE },
    ...
    { SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ_BIT, SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ },
    { SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE_BIT, SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE },
    ...
    { SYNC_GEOMETRY_SHADER_MEMORY_READ_BIT, SYNC_GEOMETRY_SHADER_MEMORY_READ },
    { SYNC_GEOMETRY_SHADER_MEMORY_WRITE_BIT, SYNC_GEOMETRY_SHADER_MEMORY_WRITE },
    ...
    { SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ_BIT, SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ },
    { SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE_BIT, SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE },
    ...
    { SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ_BIT, SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ },
    { SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE_BIT, SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE },
    { SYNC_TASK_SHADER_NV_MEMORY_READ_BIT, SYNC_TASK_SHADER_NV_MEMORY_READ },
    { SYNC_TASK_SHADER_NV_MEMORY_WRITE_BIT, SYNC_TASK_SHADER_NV_MEMORY_WRITE },
    ...
    { SYNC_MESH_SHADER_NV_MEMORY_READ_BIT, SYNC_MESH_SHADER_NV_MEMORY_READ },
    { SYNC_MESH_SHADER_NV_MEMORY_WRITE_BIT, SYNC_MESH_SHADER_NV_MEMORY_WRITE },
    ...
    { SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ_BIT, SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ },
    { SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE_BIT, SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE },
    ...
    { SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ_BIT, SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ },
    { SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE_BIT, SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE },
    { SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ_BIT, SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ },
    { SYNC_FRAGMENT_SHADER_MEMORY_READ_BIT, SYNC_FRAGMENT_SHADER_MEMORY_READ },
    { SYNC_FRAGMENT_SHADER_MEMORY_WRITE_BIT, SYNC_FRAGMENT_SHADER_MEMORY_WRITE },
    ...
    { SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ_BIT, SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ },
    { SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE_BIT, SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE },
    ...
    { SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ_BIT, SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ },
    { SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE_BIT, SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE },
    { SYNC_COMPUTE_SHADER_MEMORY_READ_BIT, SYNC_COMPUTE_SHADER_MEMORY_READ },
    { SYNC_COMPUTE_SHADER_MEMORY_WRITE_BIT, SYNC_COMPUTE_SHADER_MEMORY_WRITE },
    ...
    { SYNC_TRANSFER_MEMORY_READ_BIT, SYNC_TRANSFER_MEMORY_READ },
    { SYNC_TRANSFER_MEMORY_WRITE_BIT, SYNC_TRANSFER_MEMORY_WRITE },
    ...
    { SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ_BIT, SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ },
    { SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE_BIT, SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE },
    ...
    { SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ_BIT, SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ },
    { SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE_BIT, SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE },
    ...
    { SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ_BIT, SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ },
    { SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE_BIT, SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE },
    ...
    { SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ_BIT, SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ },
    { SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE_BIT, SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE },
    { SYNC_BOTTOM_OF_PIPE_MEMORY_READ_BIT, SYNC_BOTTOM_OF_PIPE_MEMORY_READ },
    { SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE_BIT, SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE },
    { SYNC_HOST_HOST_READ_BIT, SYNC_HOST_HOST_READ },
    { SYNC_HOST_HOST_WRITE_BIT, SYNC_HOST_HOST_WRITE },
    { SYNC_HOST_MEMORY_READ_BIT, SYNC_HOST_MEMORY_READ },
    { SYNC_HOST_MEMORY_WRITE_BIT, SYNC_HOST_MEMORY_WRITE },
...
static std::array<SyncStageAccessInfoType, 103> syncStageAccessInfoByStageAccessIndex = { {
    {
        "SYNC_TOP_OF_PIPE_MEMORY_READ",
        VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TOP_OF_PIPE_MEMORY_READ,
        SYNC_TOP_OF_PIPE_MEMORY_READ_BIT

    },
    {
        "SYNC_TOP_OF_PIPE_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TOP_OF_PIPE_MEMORY_WRITE,
        SYNC_TOP_OF_PIPE_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_DRAW_INDIRECT_MEMORY_READ",
        VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_DRAW_INDIRECT_MEMORY_READ,
        SYNC_DRAW_INDIRECT_MEMORY_READ_BIT

    },
    {
        "SYNC_DRAW_INDIRECT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_DRAW_INDIRECT_MEMORY_WRITE,
        SYNC_DRAW_INDIRECT_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_VERTEX_INPUT_MEMORY_READ",
        VK_PIPELINE_STAGE_VERTEX_INPUT_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_VERTEX_INPUT_MEMORY_READ,
        SYNC_VERTEX_INPUT_MEMORY_READ_BIT

    },
    {
        "SYNC_VERTEX_INPUT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_VERTEX_INPUT_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_VERTEX_INPUT_MEMORY_WRITE,
        SYNC_VERTEX_INPUT_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_VERTEX_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_VERTEX_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_VERTEX_SHADER_MEMORY_READ,
        SYNC_VERTEX_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_VERTEX_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_VERTEX_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_VERTEX_SHADER_MEMORY_WRITE,
        SYNC_VERTEX_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ,
        SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE,
        SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ,
        SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE,
        SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_GEOMETRY_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_GEOMETRY_SHADER_MEMORY_READ,
        SYNC_GEOMETRY_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_GEOMETRY_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_GEOMETRY_SHADER_MEMORY_WRITE,
        SYNC_GEOMETRY_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ",
        VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ,
        SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ_BIT

    },
    {
        "SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE,
        SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ",
        VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ,
        SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ_BIT

    },
    {
        "SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE,
        SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE_BIT

    },
    {
        "SYNC_TASK_SHADER_NV_MEMORY_READ",
        VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TASK_SHADER_NV_MEMORY_READ,
        SYNC_TASK_SHADER_NV_MEMORY_READ_BIT

    },
    {
        "SYNC_TASK_SHADER_NV_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TASK_SHADER_NV_MEMORY_WRITE,
        SYNC_TASK_SHADER_NV_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_MESH_SHADER_NV_MEMORY_READ",
        VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_MESH_SHADER_NV_MEMORY_READ,
        SYNC_MESH_SHADER_NV_MEMORY_READ_BIT

    },
    {
        "SYNC_MESH_SHADER_NV_MEMORY_WRITE",
        VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_MESH_SHADER_NV_MEMORY_WRITE,
        SYNC_MESH_SHADER_NV_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ",
        VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ,
        SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ_BIT

    },
    {
        "SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE",
        VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE,
        SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ",
        VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ,
        SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ_BIT

    },
    {
        "SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE",
        VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE,
        SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_FRAGMENT_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_FRAGMENT_SHADER_MEMORY_READ,
        SYNC_FRAGMENT_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_FRAGMENT_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_FRAGMENT_SHADER_MEMORY_WRITE,
        SYNC_FRAGMENT_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ",
        VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ,
        SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ_BIT

    },
    {
        "SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE",
        VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE,
        SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ",
        VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ,
        SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ_BIT

    },
    {
        "SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE,
        SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE_BIT

    },
    {
        "SYNC_COMPUTE_SHADER_MEMORY_READ",
        VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_COMPUTE_SHADER_MEMORY_READ,
        SYNC_COMPUTE_SHADER_MEMORY_READ_BIT

    },
    {
        "SYNC_COMPUTE_SHADER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_COMPUTE_SHADER_MEMORY_WRITE,
        SYNC_COMPUTE_SHADER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_TRANSFER_MEMORY_READ",
        VK_PIPELINE_STAGE_TRANSFER_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_TRANSFER_MEMORY_READ,
        SYNC_TRANSFER_MEMORY_READ_BIT

    },
    {
        "SYNC_TRANSFER_MEMORY_WRITE",
        VK_PIPELINE_STAGE_TRANSFER_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_TRANSFER_MEMORY_WRITE,
        SYNC_TRANSFER_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ",
        VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ,
        SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ_BIT

    },
    {
        "SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE",
        VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE,
        SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ",
        VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ,
        SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ_BIT

    },
    {
        "SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE",
        VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE,
        SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ,
        SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ_BIT

    },
    {
        "SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE",
        VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE,
        SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ",
        VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ,
        SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ_BIT

    },
    {
        "SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE",
        VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE,
        SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE_BIT

    },
    {
        "SYNC_BOTTOM_OF_PIPE_MEMORY_READ",
        VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_BOTTOM_OF_PIPE_MEMORY_READ,
        SYNC_BOTTOM_OF_PIPE_MEMORY_READ_BIT

    },
    {
        "SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE",
        VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE,
        SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE_BIT
    ...
    {
        "SYNC_HOST_MEMORY_READ",
        VK_PIPELINE_STAGE_HOST_BIT,
        VK_ACCESS_MEMORY_READ_BIT,
        SYNC_HOST_MEMORY_READ,
        SYNC_HOST_MEMORY_READ_BIT

    },
    {
        "SYNC_HOST_MEMORY_WRITE",
        VK_PIPELINE_STAGE_HOST_BIT,
        VK_ACCESS_MEMORY_WRITE_BIT,
        SYNC_HOST_MEMORY_WRITE,
        SYNC_HOST_MEMORY_WRITE_BIT
...
static std::map<VkPipelineStageFlags, std::map<VkAccessFlags, SyncStageAccessIndex>> syncStageAccessIndexByStageAndAccess = {
    { VK_PIPELINE_STAGE_ACCELERATION_STRUCTURE_BUILD_BIT_KHR, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_ACCELERATION_STRUCTURE_BUILD_KHR_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_BOTTOM_OF_PIPE_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_BOTTOM_OF_PIPE_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_BOTTOM_OF_PIPE_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_COLOR_ATTACHMENT_OUTPUT_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_COMMAND_PREPROCESS_BIT_NV, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_COMMAND_PREPROCESS_NV_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_COMMAND_PREPROCESS_NV_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_COMPUTE_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_COMPUTE_SHADER_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_CONDITIONAL_RENDERING_BIT_EXT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_CONDITIONAL_RENDERING_EXT_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_DRAW_INDIRECT_BIT, {
        { VK_ACCESS_INDIRECT_COMMAND_READ_BIT, SYNC_DRAW_INDIRECT_INDIRECT_COMMAND_READ },
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_DRAW_INDIRECT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_DRAW_INDIRECT_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_EARLY_FRAGMENT_TESTS_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_EARLY_FRAGMENT_TESTS_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_FRAGMENT_DENSITY_PROCESS_BIT_EXT, {
        { VK_ACCESS_FRAGMENT_DENSITY_MAP_READ_BIT_EXT, SYNC_FRAGMENT_DENSITY_PROCESS_EXT_FRAGMENT_DENSITY_MAP_READ_EXT },
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_FRAGMENT_DENSITY_PROCESS_EXT_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT, {
        { VK_ACCESS_INPUT_ATTACHMENT_READ_BIT, SYNC_FRAGMENT_SHADER_INPUT_ATTACHMENT_READ },
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_FRAGMENT_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_FRAGMENT_SHADER_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_GEOMETRY_SHADER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_GEOMETRY_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_GEOMETRY_SHADER_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_HOST_BIT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_HOST_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_HOST_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_LATE_FRAGMENT_TESTS_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_LATE_FRAGMENT_TESTS_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_MESH_SHADER_BIT_NV, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_MESH_SHADER_NV_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_MESH_SHADER_NV_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_RAY_TRACING_SHADER_BIT_KHR, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_RAY_TRACING_SHADER_KHR_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_RAY_TRACING_SHADER_KHR_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_SHADING_RATE_IMAGE_BIT_NV, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_SHADING_RATE_IMAGE_NV_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_SHADING_RATE_IMAGE_NV_MEMORY_WRITE },
        { VK_ACCESS_SHADING_RATE_IMAGE_READ_BIT_NV, SYNC_SHADING_RATE_IMAGE_NV_SHADING_RATE_IMAGE_READ_NV }
    } },
    { VK_PIPELINE_STAGE_TASK_SHADER_BIT_NV, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TASK_SHADER_NV_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TASK_SHADER_NV_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TESSELLATION_CONTROL_SHADER_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_TESSELLATION_EVALUATION_SHADER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TESSELLATION_EVALUATION_SHADER_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TOP_OF_PIPE_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TOP_OF_PIPE_MEMORY_WRITE }
    } },
    { VK_PIPELINE_STAGE_TRANSFER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TRANSFER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TRANSFER_MEMORY_WRITE },
        { VK_ACCESS_TRANSFER_READ_BIT, SYNC_TRANSFER_TRANSFER_READ },
        { VK_ACCESS_TRANSFER_WRITE_BIT, SYNC_TRANSFER_TRANSFER_WRITE }
    } },
    { VK_PIPELINE_STAGE_TRANSFORM_FEEDBACK_BIT_EXT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_TRANSFORM_FEEDBACK_EXT_MEMORY_WRITE },
    ...
    { VK_PIPELINE_STAGE_VERTEX_INPUT_BIT, {
        ...
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_VERTEX_INPUT_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_VERTEX_INPUT_MEMORY_WRITE },
        { VK_ACCESS_VERTEX_ATTRIBUTE_READ_BIT, SYNC_VERTEX_INPUT_VERTEX_ATTRIBUTE_READ }
    } },
    { VK_PIPELINE_STAGE_VERTEX_SHADER_BIT, {
        { VK_ACCESS_MEMORY_READ_BIT, SYNC_VERTEX_SHADER_MEMORY_READ },
        { VK_ACCESS_MEMORY_WRITE_BIT, SYNC_VERTEX_SHADER_MEMORY_WRITE },
